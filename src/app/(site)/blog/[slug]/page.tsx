        ...
        <div className="blog-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 40, alignItems: 'start' }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            {(() => {
              ...
              if (home && !away) {
                const textSearch = (post.resumo || '') + ' ' + (rawContent || '');
              ...
              return (
                <div style={{ background: 'linear-gradient(135deg, rgba(15,15,26,0.95), rgba(229,9,20,0.18))', border: '1px solid rgba(229,9,20,0.3)', borderRadius: 20, padding: '20px 24px', marginBottom: 32, display: 'flex', alignItems: 'center', gap: 20, boxShadow: '0 10px 30px rgba(0,0,0,0.6)' }}>
                  ...
                  <a href={activeCta.url_destino} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '10px 18px', borderRadius: 99, background: '#E50914', color: '#FFF', fontWeight: 700, fontSize: 12, textDecoration: 'none', fontFamily: 'Outfit, sans-serif' }}>
